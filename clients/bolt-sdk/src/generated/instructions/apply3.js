 ...
 * @category generated
 */
function createApply3Instruction(accounts, args, programId = new web3.PublicKey('WorLD15A7CrDwLcLy4fRqtaTb9fbd8o8iqiEMUDse2n')) {
    const [data] = exports.apply3Struct.serialize(Object.assign({ instructionDiscriminator: exports.apply3InstructionDiscriminator }, args));
    const keys = [
        {
