 ...
 * @category generated
 */
function createApply2Instruction(accounts, args, programId = new web3.PublicKey('WorLD15A7CrDwLcLy4fRqtaTb9fbd8o8iqiEMUDse2n')) {
    const [data] = exports.apply2Struct.serialize(Object.assign({ instructionDiscriminator: exports.apply2InstructionDiscriminator }, args));
    const keys = [
        {
