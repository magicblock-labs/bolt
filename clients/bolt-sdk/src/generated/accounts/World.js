...
class World {
     ...
     */
    serialize() {
        return exports.worldBeet.serialize(Object.assign({ accountDiscriminator: exports.worldDiscriminator }, this));
    }
    /**
    ...
    static getMinimumBalanceForRentExemption(connection, commitment) {
        return __awaiter(this, void 0, void 0, function* () {
            return connection.getMinimumBalanceForRentExemption(World.byteSize, commitment);
        });
    }
    /**
