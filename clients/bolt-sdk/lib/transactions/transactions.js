...
exports.ApplySystem = exports.createApplySystemInstruction = exports.InitializeComponent = exports.AddEntity = exports.InitializeNewWorld = void 0;
...
function AddEntity(_a) {
    var payer = _a.payer, world = _a.world, connection = _a.connection;
    return __awaiter(this, void 0, void 0, function () {
...
function createApplySystemInstruction(_a) {
    var entity = _a.entity, components = _a.components, system = _a.system, seeds = _a.seeds, authority = _a.authority, extraAccounts = _a.extraAccounts, args = _a.args;
    ...
    if (seeds == null)
        seeds = new Array(components.length).fill("");
    if (seeds.length !== components.length)
        throw new Error("Seed length does not match components length");
    var componentPdas = [];
    for (var i = 0; i < components.length; i++) {
        var componentPda = (0, index_1.FindComponentPda)(components[i], entity, seeds[i]);
...
function ApplySystem(_a) {
    var authority = _a.authority, system = _a.system, entity = _a.entity, components = _a.components, _b = _a.args, args = _b === void 0 ? {} : _b, extraAccounts = _a.extraAccounts, seeds = _a.seeds;
    return __awaiter(this, void 0, void 0, function () {
        var applySystemIx;
        return __generator(this, function (_c) {
