...
export declare function AddEntity({ payer, world, connection, }: {
    payer: PublicKey;
    world: PublicKey;
    connection: Connection;
}): Promise<{
...
export declare function createApplySystemInstruction({ entity, components, system, seeds, authority, extraAccounts, args, }: ApplySystemInstruction): web3.TransactionInstruction;
export declare function ApplySystem({ authority, system, entity, components, args, extraAccounts, seeds, }: {
    authority: PublicKey;
    system: PublicKey;
    entity: PublicKey;
    components: PublicKey[];
