...
exports.SerializeArgs = exports.FindComponentPda = exports.FindEntityPda = exports.FindWorldPda = exports.FindWorldRegistryPda = exports.PROGRAM_ID = exports.SYSVAR_INSTRUCTIONS_PUBKEY = exports.PROGRAM_ADDRESS = void 0;
...
__exportStar(require("./delegation/instructions"), exports);
exports.PROGRAM_ADDRESS = "WorLD15A7CrDwLcLy4fRqtaTb9fbd8o8iqiEMUDse2n";
exports.SYSVAR_INSTRUCTIONS_PUBKEY = new web3_js_1.PublicKey("Sysvar1nstructions1111111111111111111111111");
exports.PROGRAM_ID = new web3_js_1.PublicKey(exports.PROGRAM_ADDRESS);
function FindWorldRegistryPda(programId) {
    if (programId === void 0) { programId = new web3_js_1.PublicKey(exports.PROGRAM_ID); }
    return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("registry")], programId)[0];
}
...
function FindWorldPda(id, programId) {
    ...
    return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("world"), idBuffer], programId)[0];
}
...
function FindComponentPda(componentProgramId, entity, componentId) {
    ...
    return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(componentId), entity.toBytes()], componentProgramId)[0];
}
