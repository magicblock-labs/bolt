...
function createDelegateInstruction(accounts, validUntil, commitFrequencyMs, programId) {
    var _a, _b, _c, _d, _e;
    if (validUntil === void 0) { validUntil = 0; }
    if (commitFrequencyMs === void 0) { commitFrequencyMs = 30000; }
    ...
    var _f = (0, accounts_1.getDelegationAccounts)(accounts.account, accounts.ownerProgram), delegationPda = _f.delegationPda, delegatedAccountSeedsPda = _f.delegatedAccountSeedsPda, bufferPda = _f.bufferPda;
    var keys = [
        {
        ...
        {
            pubkey: (_b = accounts.delegationRecord) !== null && _b !== void 0 ? _b : delegationPda,
            isWritable: true,
            isSigner: false,
        },
        {
            pubkey: (_c = accounts.delegateAccountSeeds) !== null && _c !== void 0 ? _c : delegatedAccountSeedsPda,
            isWritable: true,
            isSigner: false,
        },
        {
            pubkey: (_d = accounts.delegationProgram) !== null && _d !== void 0 ? _d : new web3.PublicKey(accounts_1.DELEGATION_PROGRAM_ID),
            isWritable: false,
            isSigner: false,
        },
        {
