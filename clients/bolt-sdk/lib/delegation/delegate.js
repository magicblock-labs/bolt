...
function getDelegationAccounts(accountToDelegate, ownerProgram, ownedBuffer) {
    ...
    var newStatePda = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from(SEED_STATE_DIFF_PDA), pdaBytes], new web3_js_1.PublicKey(exports.DELEGATION_PROGRAM_ID))[0];
    return {
