...
var Entity = (function () {
  ...
  Entity.fromAccountAddress = function (
    connection,
    address,
    commitmentOrConfig
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (accountInfo == null) {
              throw new Error(
                "Unable to find Entity account at ".concat(address)
              );
            }
  ...
  Entity.prototype.serialize = function () {
    return exports.entityBeet.serialize(
      __assign({ accountDiscriminator: exports.entityDiscriminator }, this)
    );
  };
