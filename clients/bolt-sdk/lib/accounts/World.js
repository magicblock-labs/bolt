...
var World = (function () {
  ...
  World.fromAccountAddress = function (
    connection,
    address,
    commitmentOrConfig
  ) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            if (accountInfo == null) {
              throw new Error(
                "Unable to find World account at ".concat(address)
              );
            }
  ...
  World.prototype.serialize = function () {
    return exports.worldBeet.serialize(
      __assign({ accountDiscriminator: exports.worldDiscriminator }, this)
    );
  };
