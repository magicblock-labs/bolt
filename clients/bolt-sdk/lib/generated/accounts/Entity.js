...
var Entity = (function () {
    ...
    Entity.fromArgs = function (args) {
        return new Entity(args.id);
    };
    Entity.fromAccountInfo = function (accountInfo, offset) {
        if (offset === void 0) { offset = 0; }
        return Entity.deserialize(accountInfo.data, offset);
    };
    Entity.fromAccountAddress = function (connection, address, commitmentOrConfig) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        accountInfo = _a.sent();
                        if (accountInfo == null) {
                            throw new Error("Unable to find Entity account at ".concat(address));
                        }
                        return [2, Entity.fromAccountInfo(accountInfo, 0)[0]];
                }
            });
        });
    };
    Entity.gpaBuilder = function (programId) {
    ...
    Entity.deserialize = function (buf, offset) {
        if (offset === void 0) { offset = 0; }
        return exports.entityBeet.deserialize(buf, offset);
    };
    Entity.prototype.serialize = function () {
        return exports.entityBeet.serialize(__assign({ accountDiscriminator: exports.entityDiscriminator }, this));
    };
    Object.defineProperty(Entity, "byteSize", {
        get: function () {
    ...
    Entity.getMinimumBalanceForRentExemption = function (connection, commitment) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, connection.getMinimumBalanceForRentExemption(Entity.byteSize, commitment)];
            });
        });
    };
    Entity.hasCorrectByteSize = function (buf, offset) {
        if (offset === void 0) { offset = 0; }
        return buf.byteLength - offset === Entity.byteSize;
    };
    Entity.prototype.pretty = function () {
        var _this = this;
        return {
            id: (function () {
                var x = _this.id;
