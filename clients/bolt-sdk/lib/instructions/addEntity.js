...
exports.addEntityStruct = new beet.BeetArgsStruct([["instructionDiscriminator", beet.uniformFixedSizeArray(beet.u8, 8)]], "AddEntityInstructionArgs");
exports.addEntityInstructionDiscriminator = [
    163, 241, 57, 35, 244, 244, 48, 57,
];
function createAddEntityInstruction(accounts, programId) {
    var _a;
    if (programId === void 0) { programId = new web3.PublicKey("WorLD15A7CrDwLcLy4fRqtaTb9fbd8o8iqiEMUDse2n"); }
    var data = exports.addEntityStruct.serialize({
        instructionDiscriminator: exports.addEntityInstructionDiscriminator,
    })[0];
    var keys = [
        {
