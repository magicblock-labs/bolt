...
exports.createApply3Instruction = exports.apply3InstructionDiscriminator = exports.apply3Struct = void 0;
...
function createApply3Instruction(accounts, args, programId) {
    ...
    var data = exports.apply3Struct.serialize(__assign({ instructionDiscriminator: exports.apply3InstructionDiscriminator }, args))[0];
    var keys = [
        {
