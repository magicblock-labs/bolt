...
exports.createApply5Instruction = exports.apply5InstructionDiscriminator = exports.apply5Struct = void 0;
...
function createApply5Instruction(accounts, args, programId) {
    ...
    var data = exports.apply5Struct.serialize(__assign({ instructionDiscriminator: exports.apply5InstructionDiscriminator }, args))[0];
    var keys = [
        {
