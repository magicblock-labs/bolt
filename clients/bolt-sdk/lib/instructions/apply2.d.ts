...
export declare const apply2Struct: beet.FixableBeetArgsStruct<Apply2InstructionArgs & {
...
export declare function createApply2Instruction(accounts: Apply2InstructionAccounts, args: Apply2InstructionArgs, programId?: web3.PublicKey): web3.TransactionInstruction;
