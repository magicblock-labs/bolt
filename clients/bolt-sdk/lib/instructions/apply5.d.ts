...
export declare const apply5Struct: beet.FixableBeetArgsStruct<Apply5InstructionArgs & {
...
export declare function createApply5Instruction(accounts: Apply5InstructionAccounts, args: Apply5InstructionArgs, programId?: web3.PublicKey): web3.TransactionInstruction;
